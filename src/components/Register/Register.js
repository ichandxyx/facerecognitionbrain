...
return(
	<article class="br3 center ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-gold">
		<main class="pa4 black-80">
		  	<form class="measure ">
			    <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
			      	<legend class="f1 fw6 ph0 mh0">Register</legend>
			      	<div class="mt3">
						<label class="db fw6 lh-copy f6" for="email-name">Name</label>
